...
export const getItemBySlug = <ThrowOnError extends boolean = false>(options: Options<GetItemBySlugData, ThrowOnError>) => (options.client ?? client).get<GetItemBySlugResponses, GetItemBySlugErrors, ThrowOnError>({ url: '/api/items/slug/{slug}', ...options });
